 ...
 * ------- (FAIL_CODE) we drop out the looser :)
 */
int main(void)
{
	shell_info data;
 ...
 * ------- (FAIL_CODE) a negative number
 */
int split_line(shell_info *data)
{
	char *token;
 ...
 * ------- (FAIL_CODE) a negative number
 */
int parse_line(shell_info *data)
{
 ...
 * ------- (FAIL_CODE) a negative number
 */
int process_cmd(shell_info *data)
{
	pid_t pid;
	int status;
